...
const AveragePace2 = () => {
  return (
    <View style={{ paddingHorizontal: 22, paddingVertical: 20 }}>
      <View style={{ left: 32 }}>
        <Text style={styles.indication}>Peak (5:20 min/km)</Text>
      </View>
      <Image
        source={require("@/assets/images/detailedpacegraph.png")}
        style={{ width: 312, height: 82 }}
      />
