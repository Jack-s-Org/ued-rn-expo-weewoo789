...
import CaloriesDots from "./CaloriesDots";
...
const data = [
  ...
  <Calories index={0}></Calories>,
  <Calories2 index={1}></Calories2>,
];

function CaloriesCarousel() {
  ...
  return (
    <View>
      ...
      >
        <CaloriesDots data={data} currentIndex={index} />
      </View>
    </View>
  );
}
